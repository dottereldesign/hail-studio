...
const form = useForm({
    name: '',
    layout_category_id: defaultCategoryId(),
    payload: '',
    screenshot: null,
});
...
const resetState = () => {
    ...
    form.layout_category_id = defaultCategoryId();
    payloadError.value = '';
        ...
        <div v-if="open" class="fixed inset-0 z-50 bg-[var(--color-bg-soft)] px-6 pb-10 pt-[calc(4rem+1.5rem)]" @click.self="$emit('close')">
            ...
            >
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs uppercase tracking-[0.3em] text-[var(--color-muted)]">Layouts</p>
                        <h2 id="add-layout-title" class="mt-2 text-2xl font-semibold">Create Layout</h2>
                    </div>
                    <button
                        type="button"
                ...
                <form class="mt-6 space-y-6" @submit.prevent="submit">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Pricing Layout 3"
                            required
                        >
                    ...
                    <div>
                        ...
                        <select
                            v-model.number="form.layout_category_id"
                            class="mt-2 w-full rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-2 text-sm text-[var(--color-text)] focus:border-[var(--color-border-strong)] focus:outline-none"
                            required
                        >
                            <option
                        ...
                        <p v-if="form.errors.layout_category_id" class="form-error mt-2 text-xs">
                            {{ form.errors.layout_category_id }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder='{"name": "Pricing Layout 3", "layout": {"variant": "default"}}'
                            required
                            @input="payloadError = ''"
                        />
